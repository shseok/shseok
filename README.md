...
<ol>
  ...
  <li> 
     <p style="display: flex; align-items: center; gap: 6px"> 
       <img width = "20" src="https://re-find.xyz/apple-touch-icon.png" align="center"> 
        <a href = "https://re-find.xyz/"> RE:FIND </a>
     </p> 
  </li>
  <ul>
      <li> Service to find the source of fan cafe fan art </li>
  </ul>
</ol>
